<div class="footer">
    ...
    <div class="footer_content">
        <div class="footer_section about">
            <h1 class="logo_name"><span class="part1">Rutkowski</span><span class="part2">Blog</span></h1>
            <br>
            Telefon: 696-696-696
            <br>
            Sociale:
            <a href="https://linkedin.com" target="_blank" class="social_icon">
        ...
        <div class="footer_section contact_form">
            <form action="index.html" method="post" class="contact_form_inner">
                ...
                <button type="submit" class="button button_big">Wyślij</button>
            </form>
        </div>
    </div>
